...
export default function App(){
  ...
  const profile=useMemo(()=>({id:firebaseUser?.uid||'me',name:authProfile?.displayName||firebaseUser?.displayName||'Cirilo user',role:authProfile?.role||'Member',location:'',slug:authProfile?.ciriloId||'',bio:'',ciriloId:authProfile?.ciriloId||'',photoURL:authProfile?.photoURL||firebaseUser?.photoURL||''}),[authProfile,firebaseUser])
